                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Redeem your rewards in 3 steps!',
                                          ...
                                          children: [
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(8, 0, 0, 12),
                                              child: Text(
                                                'Browse through local businesses',
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(8, 0, 0, 12),
                                              child: Text(
                                                'Send the amount of coins required ',
                                                textAlign: TextAlign.start,
                                                style: FlutterFlowTheme
                                                    .bodyText1
                                                    .override(
                                            ...
                                            children: [
                                              Align(
                                                alignment: AlignmentDirectional(
                                                    0.6, 0),
                                                child: Text(
                                                  'Bob\'s car Repair shop : 20% off seat covers',
                                                  textAlign: TextAlign.start,
                                                  style: FlutterFlowTheme
                                                      .bodyText2
                                                      .override(
                              ...
                              onPressed: () async {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Offer reserved!'),
                                      content: Text(
                                          'The business owner will soon contact you .'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                          ...
                                          children: [
                                            Align(
                                              alignment: AlignmentDirectional(
                                                  -0.15, 0),
                                              child: Text(
                                                'Dance Divas: One Free trial dance class',
                                                textAlign: TextAlign.start,
                                                style: FlutterFlowTheme
                                                    .bodyText2
                                                    .override(
